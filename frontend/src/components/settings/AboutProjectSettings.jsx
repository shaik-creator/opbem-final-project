    ...
    <div className="space-y-4">
      ...
      <div className="rounded-lg border border-gray-200 bg-white p-5 shadow-card">
        <div className="divide-y divide-gray-100">
          ...
          <SettingsRow icon={Building2} title="ORBEM Solutions Private Limited" description="Air cargo, shipment tracking, documents, payments, alerts, and reporting workflows." />
