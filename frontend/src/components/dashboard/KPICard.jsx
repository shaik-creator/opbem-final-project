export default function KPICard({ title, value, icon: Icon, tone = 'text-brand-600', subtitle }) {
  return (
    <div className="min-w-0 rounded-lg border border-gray-200 bg-white p-4 shadow-card">
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          <p className="break-words text-sm font-medium text-gray-500">{title}</p>
          <p className="mt-2 break-words text-2xl font-semibold text-gray-950">{value}</p>
