...
export default function SummaryCard({ title, value, description, icon: Icon, trend, tone = '#2563eb' }) {
  return (
    <div className="relative min-w-0 overflow-hidden rounded-lg border border-[#dbe3ea] bg-white p-4 shadow-card">
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          ...
          <p className="mt-2 break-words text-2xl font-semibold text-[#172033]">{value}</p>
